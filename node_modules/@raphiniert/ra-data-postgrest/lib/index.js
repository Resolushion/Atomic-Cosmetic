...
exports.default = (function (config) { return ({
    getList: function (resource, params) {
        ...
        var _j = (0, urlBuilder_1.parseFilters)(params, config.defaultListOp), filter = _j.filter, select = _j.select;
        ...
        if (field) {
            query.order = (0, urlBuilder_1.getOrderBy)(field, order, primaryKey, config.sortOrder);
    ...
    getManyReference: function (resource, params) {
        ...
        var query = params.target
            ? __assign((_a = {}, _a[params.target] = "eq.".concat(params.id), _a.order = (0, urlBuilder_1.getOrderBy)(field, order, primaryKey, config.sortOrder), _a.offset = String((page - 1) * perPage), _a.limit = String(perPage), _a), filter) : __assign({ order: (0, urlBuilder_1.getOrderBy)(field, order, primaryKey), offset: String((page - 1) * perPage), limit: String(perPage) }, filter);
        if (select) {
            query.select = select;
        }
        // add header that Content-Range is in returned header
    ...
    update: function (resource, params) {
        ...
        var metaSchema = (_a = params.meta) === null || _a === void 0 ? void 0 : _a.schema;
        var body = JSON.stringify(__assign({}, (0, urlBuilder_1.dataWithoutVirtualId)((0, urlBuilder_1.removePrimaryKey)(changedData, primaryKey), primaryKey)));
        return config
            .httpClient(url, {
            method: 'PATCH',
...
var getChanges = function (data, previousData) {
    var changes = Object.keys(data).reduce(function (changes, key) {
        if (!(0, isEqual_1.default)(data[key], previousData[key])) {
