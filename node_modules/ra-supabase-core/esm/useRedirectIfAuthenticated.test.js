...
describe('useRedirectIfAuthenticated', function () {
    ...
    test('should not redirect users if they are not authenticated', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            render(React.createElement(TestMemoryRouter, { initialEntries: ['/login'], locationCallback: function (l) {
                    location = l;
                } },
                React.createElement(CoreAdminContext, { authProvider: authProvider },
